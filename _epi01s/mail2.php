...
$to = "wiclinickichijouji.2@gmail.com";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "wiclinickichijouji.2@gmail.com";
...
$subject = "【吉祥寺院宛】脱毛LPよりお問い合わせがありました";
...
$refrom_name = "【ウィクリニック吉祥寺院】脱毛予約";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ウィクリニック吉祥寺院】お問い合わせありがとうございました";
						...
						<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST" class="mailForm">
							...
							<dl class="form-list">
								...
								<?php if (!empty($imgdata)) { ?>
									...
									<dd><img src="<?= 'data:' . $imginfo['mime'] . ';base64,' . $enc_img; ?>"></dd>
								<?php } ?>
							</dl>
